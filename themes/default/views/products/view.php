                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-striped dfTable table-right-left">
                            <tbody>
                                ...
                                <?php if ($Admin) {
                                    echo '<tr><td>' . lang("cost") . '</td><td>' . $this->izi->formatMoney($product->cost) . '</td></tr>';
                                }
                                ?>

                                <tr>
                                    <td><?= lang("price"); ?></td>
                                    <td><?= $this->izi->formatMoney($product->price) ?></td>
                                </tr>
                                
                                <?php if ($product->type == 'standard') { ?>
                                <tr>
                                    <td><?= lang("quantity"); ?></td>
                                    <td><?= $this->izi->formatNumber($product->quantity); ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <?php foreach ($combo_items as $combo_item) {
                                echo '<tr><td>' . $combo_item->name . ' (' . $combo_item->code . ') </td><td>' . $this->izi->formatNumber($combo_item->qty) . '</td></tr>';
                            } ?>
                        </tbody>
                    </table>
                </div>

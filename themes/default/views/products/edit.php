                            ...
                            <div class="col-md-6">
                                        ...
                                        <div class="form-group st">
                                            ...
                                            foreach ($stores_quantities as $sq) {
                                                if ($sq->store_id == $store->id) {
                                                    ...
                                                    $price = $sq->price > 0 ? $this->izi->formatMoney($sq->price) : '';
                                                    
                                                }
                                            }
                                            ?>
                                            <?= lang('quantity', 'quantity'.$store->id); ?>
                                            <?= form_input('quantity'.$store->id, set_value('quantity', $this->izi->formatQuantity($quantity)), 'class="form-control tip" id="quantity'.$store->id.'"'); ?>
                                        </div>
                                ...
                                <div class="st">
                                    <div class="form-group">
                                        ...
                                        <?= form_input('quantity', set_value('quantity', $this->izi->formatQuantity($stores_quantities->quantity)), 'class="form-control tip" id="quantity"'); ?>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>

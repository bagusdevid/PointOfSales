                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-xs-10"><?= $this->izi->hrld($purchase->date); ?></td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-striped table-bordered" style="margin-bottom:0;">
                                ...
                                <tbody>
                                    ...
                                    if ($items) {
                                        foreach ($items as $item) {
                                            ...
                                            echo '<td class="text-center">'.$this->izi->formatQuantity($item->quantity).'</td>';
                                            echo '<td class="text-right">'.$this->izi->formatMoney($item->cost).'</td>';
                                            echo '<td class="text-right">'.$this->izi->formatMoney($item->quantity*$item->cost).'</td>';
                                            echo '</tr>';
                                        }
                                    }
                                    ?>
                                ...
                                <thead>
                                    <tr class="active">
                                        ...
                                        <td class="col-xs-2"></td>
                                        <td class="col-xs-2 text-right"><?=$this->izi->formatMoney($purchase->total);?></td>
                                    </tr>
                                </thead>
                            </table>
                        </div>

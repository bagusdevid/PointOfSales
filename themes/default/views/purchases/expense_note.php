                            ...
                            <table class="table table-borderless" style="margin-bottom:0;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><strong class="text-right"><?php echo $this->izi->hrld($expense->date); ?></strong></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong class="text-right"><?php echo $this->izi->formatMoney($expense->amount); ?></strong>
                                        </td>
                                    </tr>
                                    <tr>

        ...
        <div class="modal-body">
                    ...
                    <div class="card-content white-text">
                        <svg xmlns="http://www.w3.org/2000/svg" width="353px" height="206px" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <text x="5"  y="75" style="font-size:36;fill:#FFF;">
                                <?= $Settings->currency_prefix.' '.$this->izi->formatMoney($gift_card->value); ?>
                            </text>
                            ...
                            <text x="5"  y="125" style="font-size:16;fill:#FFF;">
                                <?= $gift_card->expiry ? lang('expiry').': '.$this->izi->hrsd($gift_card->expiry) : ''; ?>
                            </text>
                            <image xlink:href="<?= $this->izi->save_barcode($gift_card->card_no, 'code128', 30, false); ?>" x="-10" y="145" height="30" width="353" />
                        </svg>
                    </div>
            ...
            if (isset($topups) && !empty($topups)) {
                ...
                foreach ($topups as $topup) {
                    echo '<tr>';
                    echo '<td>'.$this->izi->hrld($topup->date).'</td>';
                    echo '<td>'.$this->izi->formatMoney($topup->amount).'</td>';

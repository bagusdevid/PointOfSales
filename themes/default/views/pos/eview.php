                                ...
                                <table class="table table-striped table-condensed">
                                    <tbody>
                                        ...
                                        foreach ($rows as $row) {
                                            ...
                                            echo '<tr><td>' . $this->izi->formatQuantity($row->quantity) .' x '. $this->izi->formatMoney($row->net_unit_price + ($row->item_tax / $row->quantity)) . '</td>';
                                            echo '<td style="text-align:right;">' . $this->izi->formatMoney($row->subtotal) . '</td></tr>';
                                            $r++;
                                        }
                                        ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th style="text-align:right;border-top:1px dashed #000;"><?= $this->izi->formatMoney($inv->total + $inv->product_tax); ?></th>
                                        </tr>
                                        <?php
                                        if ($inv->order_tax != 0) {
                                            echo '<tr><th style="text-align:left;">' . lang("order_tax") . '</th><th style="text-align:right;">' . $this->izi->formatMoney($inv->order_tax) . '</th></tr>';
                                        }
                                        if ($inv->total_discount != 0) {
                                            echo '<tr><th style="text-align:left;">' . lang("order_discount") . '</th><th style="text-align:right;">' . $this->izi->formatMoney($inv->total_discount) . '</th></tr>';
                                        }
                                        ...
                                        if ($Settings->rounding) {
                                            ...
                                            <tr>
                                                ...
                                                <th style="text-align:right;"><?= $this->izi->formatMoney($rounding); ?></th>
                                            </tr>
                                            <tr>
                                                <th style="text-align:left;"><?= lang("grand_total"); ?></th>
                                                <th style="text-align:right;"><?= $this->izi->formatMoney($inv->grand_total + $rounding); ?></th>
                                            </tr>
                                            <?php
                                        } else {
                                            ...
                                            <tr>
                                                <th style="text-align:left;"><?= lang("grand_total"); ?></th>
                                                <th style="text-align:right;"><?= $this->izi->formatMoney($inv->grand_total); ?></th>
                                            </tr>
                                            <?php
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align:right;"><?= $this->izi->formatMoney($inv->paid); ?></th>
                                        </tr>
                                        <tr>
                                            <th style="text-align:left;"><?= lang("due_amount"); ?></th>
                                            <th style="text-align:right;"><?= $this->izi->formatMoney($inv->grand_total - $inv->paid); ?></th>
                                        </tr>
                                        <?php } ?>
                                    </tfoot>
                                </table>
                                ...
                                if ($payments) {
                                    ...
                                    foreach ($payments as $payment) {
                                        ...
                                        if (($payment->paid_by == 'CC' || $payment->paid_by == 'ppp' || $payment->paid_by == 'stripe') && $payment->cc_no) {
                                            echo '<td style="padding-left:15px;">' . lang("paid_by") . ': ' . lang($payment->paid_by) . '</td>';
                                            echo '<td style="padding-left:15px;">' . lang("amount") . ': ' . $this->izi->formatMoney($payment->pos_paid) . '</td>';
                                        ...
                                        if ($payment->paid_by == 'gift_card' && $payment->pos_paid) {
                                            ...
                                            echo '<td style="padding-left:15px;">' . lang("amount") . ': ' . $this->izi->formatMoney($payment->pos_paid) . '</td>';
                                            echo '<td style="padding-left:15px;">' . lang("balance") . ': ' . ($payment->pos_balance > 0 ? $this->izi->formatMoney($payment->pos_balance) : 0) . '</td>';
                                        }

            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="mm_sales"><a href="<?= site_url('sales'); ?>"><i class="fa fa-shopping-cart"></i> <span><?= lang('sales'); ?></span></a></li>
                                    ...
                                    <div id="botbuttons" class="col-xs-12 text-center">
                                        <div class="row">
                                            <div class="col-xs-6" style="padding: 0;">
                                                <button type="button" class="btn btn-warning btn-block btn-flat" id="reset" style="height:67px;"><?= lang('cancel'); ?></button>
                                            </div>
                                            <div class="col-xs-6" style="padding: 0;">
...
<div class="modal" data-easein="flipYIn" id="tsModal" tabindex="-1" role="dialog" aria-labelledby="tsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="tsModalLabel">Biaya Tambahan</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <?= form_textarea('address', '', 'class="form-control" id="address" style="margin-top: 10px; height: 100px;"'); ?>
                        </div>
                    </div>
                </div>
                <div style="border-bottom: 2px solid #EEE; margin-bottom: 10px;"></div>
                <span class="help-block">Ganti Nama Pengirim dan No HP di bawah ini jika sebagai dropship</span>
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label class="control-label" for="nama_pengirim">
                                Nama Pengirim
                            </label>
                            <?= form_input('nama_pengirim', $Settings->site_name, 'class="form-control input-sm kb-text" id="nama_pengirim"'); ?>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            <label class="control-label" for="no_pengirim">
                                Nomor HP Pengirim
                            </label>
                            <?= form_input('no_pengirim', $Settings->tel, 'class="form-control input-sm kb-text" id="no_pengirim"');?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('layanan', 'Regular', 'class="form-control input-sm kb-text" id="layanan"');?>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        <?php if ($this->session->userdata('rmspos')) { ?>
            ...
            <?php $this->izi->unset_data('rmspos'); } ?>

 ...
 */
$config['site_title']                 = "AikoGamis";       // Site Title, example.com This is not more functional
$config['admin_email']                = "noreply@aikogamis.com"; // Admin Email, admin@example.com This is not more functional
